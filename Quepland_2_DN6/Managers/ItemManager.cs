...
public class ItemManager
{
    ...
    public ArtisanTask GetNewArtisanTask(string skill)
    {
        ...
        {
            if (r.Output.Category == "QuestItems" || 
                r.Output.Category == "General" || 
                r.ExperienceGained == "None" || 
                r.Output.Name.Contains("Molten") ||
                r.Output.Name.Contains("Frozen") || 
                r.Output.PreventArtisanTask)
            {
                continue;
            }
